...
-- AddForeignKey
ALTER TABLE "shippingInformation" ADD CONSTRAINT "shippingInformation_cartId_fkey" FOREIGN KEY ("cartId") REFERENCES "carts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
